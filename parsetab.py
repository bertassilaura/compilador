...
_lr_productions = [
  ...
  ('program -> statement','program',1,'p_program','myParser.py',6),
  ('program -> funclist','program',1,'p_program','myParser.py',7),
  ('program -> epsilon','program',1,'p_program','myParser.py',8),
  ('funclist -> funcdef funclist2','funclist',2,'p_funclist','myParser.py',13),
  ('funclist2 -> funclist','funclist2',1,'p_funclist2','myParser.py',18),
  ('funclist2 -> epsilon','funclist2',1,'p_funclist2','myParser.py',19),
  ('funcdef -> DEF IDENT LPAREN paramlist RPAREN LCHAVES statelist RCHAVES','funcdef',8,'p_funcdef','myParser.py',24),
  ('paramlist -> INT IDENT paramlist2','paramlist',3,'p_paramlist','myParser.py',29),
  ('paramlist -> FLOAT IDENT paramlist2','paramlist',3,'p_paramlist','myParser.py',30),
  ('paramlist -> STRING IDENT paramlist2','paramlist',3,'p_paramlist','myParser.py',31),
  ('paramlist -> epsilon','paramlist',1,'p_paramlist','myParser.py',32),
  ('paramlist2 -> VIRGULA paramlist','paramlist2',2,'p_paramlist2','myParser.py',37),
  ('paramlist2 -> epsilon','paramlist2',1,'p_paramlist2','myParser.py',38),
  ('statement -> vardecl PONTO_VIRGULA','statement',2,'p_statement','myParser.py',43),
  ('statement -> atribstat PONTO_VIRGULA','statement',2,'p_statement','myParser.py',44),
  ('statement -> printstat PONTO_VIRGULA','statement',2,'p_statement','myParser.py',45),
  ('statement -> readstat PONTO_VIRGULA','statement',2,'p_statement','myParser.py',46),
  ('statement -> returnstat PONTO_VIRGULA','statement',2,'p_statement','myParser.py',47),
  ('statement -> ifstat','statement',1,'p_statement','myParser.py',48),
  ('statement -> forstat','statement',1,'p_statement','myParser.py',49),
  ('statement -> LCHAVES statelist RCHAVES','statement',3,'p_statement','myParser.py',50),
  ('statement -> BREAK PONTO_VIRGULA','statement',2,'p_statement','myParser.py',51),
  ('statement -> PONTO_VIRGULA','statement',1,'p_statement','myParser.py',52),
  ('vardecl -> INT IDENT a','vardecl',3,'p_vardecl','myParser.py',57),
  ('vardecl -> FLOAT IDENT a','vardecl',3,'p_vardecl','myParser.py',58),
  ('vardecl -> STRING IDENT a','vardecl',3,'p_vardecl','myParser.py',59),
  ('a -> LCOLCHETES INT_CONSTANT RCOLCHETES a','a',4,'p_a','myParser.py',64),
  ('a -> epsilon','a',1,'p_a','myParser.py',65),
  ('atribstat -> lvalue ATRIBUICAO atribstat2','atribstat',3,'p_atribstat','myParser.py',70),
  ('atribstat2 -> expression','atribstat2',1,'p_atribstat2','myParser.py',76),
  ('atribstat2 -> allocexpression','atribstat2',1,'p_atribstat2','myParser.py',77),
  ('atribstat2 -> funccall','atribstat2',1,'p_atribstat2','myParser.py',78),
  ('funccall -> CALL IDENT LPAREN paramlistcall RPAREN','funccall',5,'p_funccall','myParser.py',83),
  ('paramlistcall -> IDENT paramlistcall2','paramlistcall',2,'p_paramlistcall','myParser.py',89),
  ('paramlistcall -> epsilon','paramlistcall',1,'p_paramlistcall','myParser.py',90),
  ('paramlistcall2 -> VIRGULA paramlistcall','paramlistcall2',2,'p_paramlistcall2','myParser.py',95),
  ('paramlistcall2 -> epsilon','paramlistcall2',1,'p_paramlistcall2','myParser.py',96),
  ('printstat -> PRINT expression','printstat',2,'p_printstat','myParser.py',101),
  ('readstat -> READ lvalue','readstat',2,'p_readstat','myParser.py',106),
  ('returnstat -> RETURN','returnstat',1,'p_returnstat','myParser.py',111),
  ('ifstat -> IF LPAREN expression RPAREN statement ifstat2','ifstat',6,'p_ifstat','myParser.py',116),
  ('ifstat2 -> ELSE statement PONTO_VIRGULA','ifstat2',3,'p_ifstat2','myParser.py',121),
  ('ifstat2 -> PONTO_VIRGULA','ifstat2',1,'p_ifstat2','myParser.py',122),
  ('forstat -> FOR LPAREN atribstat PONTO_VIRGULA expression PONTO_VIRGULA atribstat RPAREN statement','forstat',9,'p_forstat','myParser.py',127),
  ('statelist -> statement statelist2','statelist',2,'p_statelist','myParser.py',132),
  ('statelist2 -> statelist','statelist2',1,'p_statelist2','myParser.py',137),
  ('statelist2 -> epsilon','statelist2',1,'p_statelist2','myParser.py',138),
  ('allocexpression -> NEW allocexpression2','allocexpression',2,'p_allocexpression','myParser.py',143),
  ('allocexpression2 -> INT e','allocexpression2',2,'p_allocexpression2','myParser.py',148),
  ('allocexpression2 -> FLOAT e','allocexpression2',2,'p_allocexpression2','myParser.py',149),
  ('allocexpression2 -> STRING e','allocexpression2',2,'p_allocexpression2','myParser.py',150),
  ('e -> LCOLCHETES numexpression RCOLCHETES e2','e',4,'p_e','myParser.py',155),
  ('e2 -> e','e2',1,'p_e2','myParser.py',160),
  ('e2 -> epsilon','e2',1,'p_e2','myParser.py',161),
  ('expression -> numexpression expression2','expression',2,'p_expression','myParser.py',166),
  ('expression2 -> MENOR numexpression','expression2',2,'p_expression2','myParser.py',171),
  ('expression2 -> MAIOR numexpression','expression2',2,'p_expression2','myParser.py',172),
  ('expression2 -> MENORIGUAL numexpression','expression2',2,'p_expression2','myParser.py',173),
  ('expression2 -> MAIORIGUAL numexpression','expression2',2,'p_expression2','myParser.py',174),
  ('expression2 -> IGUAL numexpression','expression2',2,'p_expression2','myParser.py',175),
  ('expression2 -> DIFERENTE numexpression','expression2',2,'p_expression2','myParser.py',176),
  ('expression2 -> epsilon','expression2',1,'p_expression2','myParser.py',177),
  ('numexpression -> term d','numexpression',2,'p_numexpression','myParser.py',183),
  ('d -> SOMA term d','d',3,'p_d','myParser.py',188),
  ('d -> SUBTRACAO term d','d',3,'p_d','myParser.py',189),
  ('d -> epsilon','d',1,'p_d','myParser.py',190),
  ('term -> unaryexpr b','term',2,'p_term','myParser.py',195),
  ('b -> MULTIPLICACAO unaryexpr b','b',3,'p_b','myParser.py',200),
  ('b -> DIVISAO unaryexpr b','b',3,'p_b','myParser.py',201),
  ('b -> RESTO unaryexpr b','b',3,'p_b','myParser.py',202),
  ('b -> epsilon','b',1,'p_b','myParser.py',203),
  ('unaryexpr -> SOMA factor','unaryexpr',2,'p_unaryexpr','myParser.py',208),
  ('unaryexpr -> SUBTRACAO factor','unaryexpr',2,'p_unaryexpr','myParser.py',209),
  ('unaryexpr -> factor','unaryexpr',1,'p_unaryexpr','myParser.py',210),
  ('factor -> INT_CONSTANT','factor',1,'p_factor','myParser.py',215),
  ('factor -> FLOAT_CONSTANT','factor',1,'p_factor','myParser.py',216),
  ('factor -> STRING_CONSTANT','factor',1,'p_factor','myParser.py',217),
  ('factor -> NULL','factor',1,'p_factor','myParser.py',218),
  ('factor -> lvalue','factor',1,'p_factor','myParser.py',219),
  ('factor -> LPAREN numexpression RPAREN','factor',3,'p_factor','myParser.py',220),
  ('lvalue -> IDENT c','lvalue',2,'p_lvalue','myParser.py',225),
  ('c -> LCOLCHETES numexpression RCOLCHETES c','c',4,'p_c','myParser.py',230),
  ('c -> epsilon','c',1,'p_c','myParser.py',231),
  ('epsilon -> <empty>','epsilon',0,'p_epsilon','myParser.py',236),
]
