...
# Expressões regulares para representar os tokens
t_ignore            = ' \t'
t_DEF               = r'def'
t_INT               = r'int'
t_FLOAT             = r'float'
...
def t_error(t):
    ...
    print(f'Caractere não permitido: {t.value[0]!r}')
    print(f'O erro ocorre na linha {t.lineno} e na posição {t.lexpos} (relativa à origem).')
    t.lexer.skip(1)
    print()
